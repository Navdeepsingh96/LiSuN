...
<html>
	...
	<body>
			...
			<header id="header">
				<div class="inner">
					...
					<nav id="nav">
						...
						<a href="issuerlogout.php?logout">Logout</a>
		...
		<!-- Banner -->
			<section id="banner">
				<h1>Welcome <?php echo $_SESSION['issuerSession']; ?></h1>
		...
		<!-- One -->
			<section id="one" class="wrapper">
				<div class="inner">
						...
						<article>
							<header>
								<h2><strong>Services provided to You!</h2>
							</header>
							<p><ul><li>View Books across all libraries.</li>
							<li>Send requests to Librarian.</li></ul></p></strong>
