...
<!-- Header -->
	...
	<img src="images/login.png"/>
		...
		<form method="POST" action="action_issuerlogin.php">
		<p><strong><font color="red">Invalid Details, Try Again!!</strong></font></p>
		<div class="form-input">
		<input type="text" name="loginid" placeholder="Enter the EmailID"/>	
		</div>
		<div class="form-input">
		<input type="password" name="password" placeholder="password"/>
		</div>
		<input type="submit" value="login" class="btn-login"/>
		<p><strong>If not registered, go to <a href="issuerregister.php">register</a> page</p></strong>
		</form>
	</div>
