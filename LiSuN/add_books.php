...
<form method="post" action="process_add_books.php">

<div class="input-group"> <label>Book Name : </label> <input type="text" name="book_name" placeholder="Enter Book Name" /> </div>
<div class="input-group"> <label>Book Author : </label> <input type="text" name="book_author" placeholder="Enter Author Name" /> </div>
<div class="input-group"> <label>Book Publication : </label> <input type="text" name="book_publication" placeholder="Enter Book Publication" /> </div>
