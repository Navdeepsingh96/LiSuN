...
<div class="header">
  <h1>View Requests</h1>
    ...
    <title>Requests for Admin</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Requests for Admin</h2>
                        <a href="adminhome.php" class="btn btn-success pull-right">Admin Home</a>
                    </div>
                    <?php
                    // Include config file
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='deleterequests.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
